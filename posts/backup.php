...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="comment.php?id=<?php echo $post_id; ?>" method="post">
                    ...
                    <button type="submit" onclick="callSubmitComment(this,<?php echo $row['id'] ?>);" class="btn btn-primary">Submit</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function callDeleteComment(buttonObj, comment_id) {
            ...
            $.ajax({
                ...
                //     $(buttonObj).closest('.comment-wrap').remove();
                // },
                error: function(data) {
    ...
    <script>
        function callSubmitComment(buttonObj, comment_id) {
                ...
                $('form').submit(function(event) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            comment: $('textarea[name="comments"]').val(), // Corrected textarea name
                            status: 1,
                        },
